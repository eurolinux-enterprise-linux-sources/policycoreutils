...
Patch6:  policycoreutils-run_init.patch
Patch7:  policycoreutils-man.patch
Patch8:  policycoreutils-load_policy.patch
Patch9:  policycoreutils-audit.patch
Patch10:  policycoreutils-unshare.patch
Patch11:  policycoreutils-terminal.patch
Patch12: policycoreutils-seobject.patch
Patch13: policycoreutils-fips.patch
Patch14: policycoreutils-RHEL6.4.patch
Patch15: policycoreutils-RHEL6.5.patch
Patch16: 0001-fixfiles-1043969.patch
Patch17: 0002-sandbox-913175.patch
Patch18: 0003-semanage-1002209.patch
Patch19: 0004-seobject-1028202.patch
Patch20: 0005-polgen-885526.patch
Patch21: 0006-semanage_seobject-1032828.patch
Patch22: 0007-sandbox_man-961805.patch
Patch23: 0008-setfiles-1098062.patch
Patch24: 0009-sandbox-1091139.patch
...
%patch5 -p1 -b .rhel6
%patch6 -p1 -b .run_init
%patch7 -p1 -b .man
%patch8 -p1 -b .load_policy
%patch9 -p1 -b .auditpwd
%patch10 -p1 -b .unshare
%patch11 -p1 -b .terminal
%patch12 -p1 -b .seobject
%patch13 -p1 -b .fips
%patch14 -p1 -b .RHEL6.4.patch
%patch15 -p1 -b .RHEL6.5.patch
%patch16 -p2 -b .1043969
%patch17 -p2 -b .913175
%patch18 -p2 -b .1002209
%patch19 -p2 -b .1028202
%patch20 -p2 -b .885526
%patch21 -p2 -b .1032828
%patch22 -p2 -b .961805
%patch23 -p2 -b .1098062
%patch24 -p2 -b .1091139
...
Group: System Environment/Base
Requires: policycoreutils-python = %{version}-%{release} 
Requires: gnome-python2-gnome, pygtk2, pygtk2-libglade, gnome-python2-canvas, gtkhtml2, gnome-python2-gtkhtml2
...
* Fri Jul 25 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.46
- Make semanage -i working on empty file
- Fix setfiles man page
- Fix setfiles -r option to be working correctly
Resolves:#1086456

* Mon Jul 21 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.45
- Additional fixes related to new noreload option
Resolves:#1119726

* Tue Jul 14 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.44
- Make semanage -i working correctly
Resolves:#1119726

* Mon Jul 14 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.43
...
* Thu Jul 3 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.42
- Fail properly on invalid options for restorecon/setfiles when using -R or -r
...
* Mon Jun 23 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.41
...
* Fri Jun 20 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.40
- Fix fixfiles to return zero value when no error is encountered
Resolves:#1043969

* Tue Oct 14 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.39
- Call glob func with GLOB_BRACE flag to cover braced expressions

* Wed Oct 2 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.38
- Fix handling fixfiles with exclude_dirs

* Wed Sep 18 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.37
- Add workaround to make allow_polyinstantiation=1 directive working for xguest with semanage-booleans
Resolves:#1008790

* Tue Sep 17 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.36
- Update semanage boolean valid options

* Tue Sep 17 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.35
- Fix setsebool to give better error message on bad boolean names
Resolves:#998974

* Thu Sep 5 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.34
- One more fix for fixfiles script

* Thu Sep 5 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.33
- Fix semanage
Resolves:#860506
...
* Thu Aug 8 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.32
- Fix setsebool man page
Resolves:#984484

* Fri Jul 19 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.31
...
* Wed Jan 16 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.30
- Fix restorecond init script
- Make setools.seinfo working only on SELinux enabled systems in seobjet.py
Resolves:#893065

* Mon Jan 7 2013 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.29
- Fix polgen.glade to contain "gtk-go-forward" label
Resolves:#885527

* Wed Dec 5 2012 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.28
- Allow to define sock file in /etc directory 
Resolves:#816460
- Make output of audit2allow when AVC can be allowed by boolean more readable

* Fri Nov 16 2012 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.27
- Fix restorecond usage
- Add missing te_stream_rules and if_stream_rules templates
Resolves:#816460
- Print a message if no default labels are assigned
Resolves:#851479

* Mon Oct 15 2012 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.26
- Fix semanage to verify that types are appropriate for commands. 
Resolves:#834160

* Tue Oct 2 2012 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.25
- Make restorecon to return proper exit codes on failure
Resolves:#824779
- Fix generated role_types for *.te
Resolves:#843727

* Wed Apr 18 2012 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.24
- Fix semanage man page
Resolves:#784595
- Fix yacc.py for FIPS mode to use sha256 instead of md5

* Mon Apr 2 2012 Miroslav Grepl <mgrepl@redhat.com> - 2.0.83-19.23
- Remove selinux_file_context_subs_dist_path() in seobject.py
Resolves:#806736

* Thu Mar 8 2012 Dan Walsh <dwalsh@redhat.com> - 2.0.83-19.22
- Make sure installing po files use -p
- Fix unchecked return codes
Resolves: #684015
- Fix semanage is sending the wrong kind of audit events 
#Related: #784595 
- Fix Polyinstantiated namespace mount leaking to excluded users 
Related: #786664 
- Fix selinux-policy update shows error parsing file obj_perm_s... 
Related: #786191

* Tue Feb 7 2012 Dan Walsh <dwalsh@redhat.com> - 2.0.83-19.21
- Fix man pages to match new semanage behaviour
Related: #785678

* Wed Feb 1 2012 Dan Walsh <dwalsh@redhat.com> - 2.0.83-19.20
- Remove selinux_file_context_subs_dist_path()
- Change md5 to sha256 in sepolgen
Related: #785678

* Fri Jan 27 2012 Dan Walsh <dwalsh@redhat.com> - 2.0.83-19.19
...
* Wed Nov 2 2011 Miroslav Grepl <mgrepl@redhat.com> 2.0.83-19.18
- Other fix for semanage man page
Resolves: #677541
- Don't report error on load_policy when system is disabled.

* Wed Nov 2 2011 Miroslav Grepl <mgrepl@redhat.com> 2.0.83-19.17
- Fix semanage man page
#Resolves: #677541

* Fri Sep 23 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.16
- Restorecon should not be exiting with a 1 when it is successful in relabeling a file
Resolves: #740699
Resolves: #739587

* Fri Sep 16 2011 Miroslav Grepl <mgrepl@redhat.com> 2.0.83-19.15
- Needs require gnome-python2-gtkhtml2 to make system-config-selinux working
- Not use open_init_pty by default

* Tue Sep 13 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.14
- restorecon should not alter MCS/MLS labels only types unless you specify -F
Resolves: #736153
#Resolves: 715021

* Tue Aug 30 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.13
- Fix spec file to require rsync for sandbox
Resolves: #734467
- Fix spec file to require gtkhtml2 for lockdown booleans program
Resolves: #702860
- Fix bugs found by Coverity
Resolves: #717640
Resolves: #728833

* Fri Jul 29 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.12
- Back port option handling in semanage to handle semodule module -D correctly
- Back port manpage from Fedora
Resolves: #666861

* Mon Jul 25 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.11
...
* Thu Jul 19 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.10
...
- Don't report error on load_policy when system is disabled.
#Resolves: #659076
- Fix unchecked return value of getpwuid()

* Thu May 25 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.9
- selinux-polgengui should not blow up on disabled SELinux system
Resolves: #695288
CVE-2011-1011 policycoreutils: insecure temporary directory handling in seunshare
Resolves: #679690
check return value of getpwuid()
Fix semanage module -D' traceback
Resolves: #666861 
sandbox -- AttributeError: 'module' object has no attribute 'chcon' 	
Resolves: #690502 	
system-config-selinux could not open interface info 	
Resolves: #696809
Mv sandbox.conf.5.gz to sandbox.5.gz and put in base package
Resolves: #690744 
sestatus usage message not complete (missing -b option) 	
Resolves: #705027
correct package name in the -sandbox subpackage description 	
Resolves: #679798
dracut attempts to load_policy with SELinux=disabled 	
Resolves: #659076
# restorecond doesn't work for user home directories on a server 	
Resolves: #658532
8 options are not described in semanage man page 	
Resolves: #677541
Mention "semanage module" in semanage man page 	 
Resolves: #677542
Update translations
Allow polcycoreutils-gui and tools to run on disabled SELinux systems
Resolves: #695288 
Resolves: #689153

* Wed Apr 25 2011 Dan Walsh <dwalsh@redhat.com> 2.0.83-19.1
