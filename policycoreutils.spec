...
%patch0 -p0 -b .policycoreutils-rhel
UpdateTimestamps -p0 %{PATCH0}
cd policycoreutils-2.5/
%patch10 -p2 -b .preserve-timestamps
cd ..
...
%patch1 -p0 -b .sepolgen-rhel
UpdateTimestamps -p0 %{PATCH1}
...
%dir %{python_sitearch}/seobject
%{python_sitearch}/seobject/__init__.py*
%{python_sitearch}/seobject*.egg-info
...
* Thu Mar 30 2017 Petr Lautrbach <plautrba@redhat.com> - 2.5-16
- Strip non-printable characters when parsing audit messages (#1406328)
- Install seobject python module into arch specific path (#1061049)
- restorecond: Decrease loglevel of termination message (#1422121)
- semodule_package: do not fail with an empty fc file (#1390535)

* Tue Mar 28 2017 Petr Lautrbach <plautrba@redhat.com> - 2.5-15
- sepolicy: Do not fail when file_contexts.{homedirs,local} are not present (#1395778)
- fixfiles - use quotes around "$FILEPATH" (#1241946)

* Thu Mar 23 2017 Petr Lautrbach <plautrba@redhat.com> - 2.5-14
- Fix export of fcontext socket entries (#1435100)
- Fix checks whether a module name is passed to semanage-module (#1420527)

* Fri Mar 03 2017 Petr Lautrbach <plautrba@redhat.com> - 2.5-13
- hll/pp: Fix pp crash when processing base module (#1350806)
- sepolicy: fix obtaining domain name in HTMLManPages (#1174744)

* Mon Jan 23 2017 Vit Mojzis <vmojzis@redhat.com> - 2.5-12
- semanage: don't skip reserved_port_t (#1225810)

* Thu Dec 01 2016 Petr Lautrbach <plautrba@redhat.com> - 2.5-11
- seobject: Handle python error returns correctly (#1398427)

* Wed Nov 16 2016 Petr Lautrbach <plautrba@redhat.com> - 2.5-10
- Re-add module versions to 'semodule -l' output (#1392573)

* Wed Oct 05 2016 Petr Lautrbach <plautrba@redhat.com> 2.5-9
- sandbox: create a new session for sandboxed processes - CVE-2016-7545
- sandbox: do not try to setup directories without -X or -M

* Fri Aug 26 2016 Petr Lautrbach <plautrba@redhat.com> 2.5-8
...
* Wed Aug 10 2016 Petr Lautrbach <plautrba@redhat.com> 2.5-7
...
* Wed Aug 03 2016 Petr Lautrbach <plautrba@redhat.com> 2.5-6.2
- open_init_pty: Do not error on EINTR
- Fix [-s STORE] typos in semanage
- Don't use subprocess.getstatusoutput() in Python 2 code

* Thu Jul 14 2016 Petr Lautrbach <plautrba@redhat.com> - 2.5-5.1
- Update translations

* Thu Jul 07 2016 Petr Lautrbach <plautrba@redhat.com> - 2.5-4
- Use patches from RHEL-7.2 to avoid some regressions
...
* Tue Oct 06 2015 Petr Lautrbach <plautrba@redhat.com> 2.2.5-20
- seunshare: Try to use setcurrent before setexec
Resolves: rhbz#1268813

* Wed Aug 19 2015 Petr Lautrbach <plautrba@redhat.com> 2.2.5-19
- Revert previous changes

* Fri Jul 10 2015 Petr Lautrbach <plautrba@redhat.com> 2.2.5-18
- fixfiles: Fix several spellcheck warnings

* Thu Jul 09 2015 Petr Lautrbach <plautrba@redhat.com> 2.2.5-17
- Fix handling of Forking daemon, to allow systemd to handle it better
Resolves: rhbz#1186648
- Fix typo in semanage args for minimum policy store
Resolves: rhbz#1208797
- Allow to define sock file in /etc directory
Resolves: rhbz#1188360

* Tue Jul 07 2015 Petr Lautrbach <plautrba@redhat.com> 2.2.5-16
- semanage: Use OrderedDict for list of fcontexts
Resolves: rhbz#1206769
- fixfiles: Cover file_context.XXX.homedir
Resolves: rhbz#1186640


* Mon Nov 10 2014 Miroslav Grepl <mgrepl@redhat.com> 2.2.5-15
- Fix sepolicy.search() to get good results everytime.
Resolves:#1092356

* Mon Oct 20 2014 Petr Lautrbach <plautrba@redhat.com> 2.2.5-14
- Fix semanage's man pages and help output
Resolves: #1085246

* Mon Sep 29 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.2.5-13
- If the user attempts to restorecon the label of a file that does not exist, do not report this as an error
Resolves:#1082956
...
Resolves:#1075023
- Update XDG_RUNTIME_DIR directory
Resolves:#1112811
- Fix semanage man page to talk about  semanage-* (8) man pages.
Resolves:#1084390

* Fri Jun 13 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.2.5-12
- Make selinux-policy build working also on another architectures related to sepolicy-manpage generate
Resolves:#1103292

* Fri Apr 4 2014 Dan Walsh <dwalsh@redhat.com> - 2.2.5-11
- One more time
- Update Translations
Resolves: #1030373

* Mon Mar 31 2014 Dan Walsh <dwalsh@redhat.com> - 2.2.5-10
- Update Translations
Resolves: #1030373

* Mon Mar 31 2014 Dan Walsh <dwalsh@redhat.com> - 2.2.5-9
- Update Translations
Resolves: #1030373
...
* Sun Mar 16 2014 Dan Walsh <dwalsh@redhat.com> - 2.2.5-7
- yum should not be required for -python package

* Wed Feb 26 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.2.5-6
Fix spec file to remove run_init which is no longer used because of systemd
Resolves:#825725

* Thu Jan 30 2014 Miroslav Grepl <mgrepl@redhat.com> - 2.2.5-5
- Remove default s0 range from semanage-login command. It is handled in seobject.py.
Resolves:#1028106
...
* Fri Dec 27 2013 Daniel Mach <dmach@redhat.com> - 2.2.4-7
...
* Tue Nov 12 2013 Dan Walsh <dwalsh@redhat.com> - 2.1.14-89
- Update to latest sepolicy tool chain.
- Document semodule -P
- Verify input to semanage permissive -a is a valid domain.
- Assigning login user with semanage login, range should default to user record
